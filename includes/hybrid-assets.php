...
<script type="text/javascript">
	...
	var bookinglistUrl= "<?php echo AIRBNB_LISTING_URL ?>";
	var bookingUrl    = "<?php echo AIRBNB_PROPERTY_URL ?>"; 
	var uplistingPropertyID = "<?php echo get_post_meta (get_the_ID(), 'property_lavanda_id', TRUE) ?>";
	var propertyIDs = '<?php echo json_encode($property_ids) ?>';
